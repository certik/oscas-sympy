...
\def\pf{{\bf proof}:\ }
\def\qed{$\Box$}
\def\OCx{Ond\v rej \v Cert\' ik}
\def\OC{\OCx\ } % with a space at the end
...
are Aaron Meurer, \OCx, Brian Granger, Matuesz Paprocki, Ronan Lamy, and Chris
...
\noindent
{\it Acknowledgements}:
I thank \OCx, Aaron Meurer, Mateusz Paprocki, Vladimir Peri\'c and Brian Granger  
